...
@interface UIView (FindRNSScreen)
-(RNSScreenView*)rnsScreenView;
@end

@implementation UIView (FindRNSScreen)

-(RNSScreenView*)rnsScreenView {

    UIView *sv = self.superview;
    while (sv != nil) {
        if ([sv isKindOfClass:[RNSScreenView class]]) {
            return (RNSScreenView*)sv;
        }
        sv = sv.superview;
    }
